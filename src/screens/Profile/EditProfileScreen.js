...
export default function EditProfileScreen({ navigation }) {
  ...
  // 📸 PICK & UPLOAD PROFILE IMAGE (Cloudinary)
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity activeOpacity={0.9} onPress={handleEmailPress}>
            <Input
              ...
              editable={false}
              placeholder="Email"
              style={!isVerified && { backgroundColor: "#f2f2f2", color: "#888" }}
            />
          </TouchableOpacity>
          ...
          {!isVerified && (
            <View style={styles.verifyContainer}>
              ...
              <Button
                title={emailSending ? "Sending..." : "Resend Verification Email"}
                onPress={handleResendVerification}
...
const styles = StyleSheet.create({
  ...
  verifyContainer: { marginVertical: 8, alignItems: "flex-start" },
