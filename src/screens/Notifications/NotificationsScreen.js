...
export default function NotificationsScreen({ navigation }) {
    ...
    >
      ...
      <View style={styles.actions}>
        <TouchableOpacity onPress={() => handleToggleRead(item)} style={styles.iconBtn}>
          <Ionicons name={item.read ? "mail-unread-outline" : "mail-open-outline"} size={20} color="#666" />
        </TouchableOpacity>
  ...
  return (
    <View style={styles.container}>
      <Header title="Notifications" rightIcon="trash-outline" onRightPress={handleDeleteAll} />
