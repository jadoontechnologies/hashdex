...
import { View, FlatList, StyleSheet, Alert, Text, Image } from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            icon="lock-closed-outline" // keep for now, optional PNG can replace
...
const styles = StyleSheet.create({
  ...
  lockIcon: {
    ...
    height: 20,
    marginRight: 8,
    tintColor: "#C84C70", // optional: color the icon
  },
  userInfo: {
    flex: 1,
    marginLeft: 12,
